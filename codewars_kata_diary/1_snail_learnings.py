...
# %%
# list(zip(*my_list)) returns a list of tuples where the first tuple contains the first element of each list in my_list, the second tuple contains the second element of each list in my_list, etc.
